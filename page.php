...
?>
    <main>
        <?php if ($main):
            ...
            ?>
            <section id="main" class="overflow-x-hidden md:mt-0 mt-[60px]">
                <div class="container relative z-10 md:min-h-auto min-h-[578px] ">
                    <!-- Декоративный типографический фон -->
                    <article aria-hidden="true"
                             class="pointer-events-none select-none w-full lg:mt-0 mt-10 md:relative absolute md:bottom-0  bottom-10 left-0 md:px-0 px-5">
                        <!-- большие буквы как фон (SVG/изображение), без alt -->
                        <svg aria-hidden="true" class="flex-none" width="100%" viewBox="0 0 1847 375" fill="none"
                        ...
                        <h1 class="absolute onest md:mt-3 md:top-auto top-[-60px] md:right-auto right-5 md:text-left text-right md:text-secondary text-white lg:text-[25px] text-lg lowercase text-secondary;"><?php echo $title; ?></h1>
                    </article>

                    <?php if (!empty($book_page)) : ?>
                        <a rel="noopener noreferrer" target="_blank" href="<?php echo esc_url($book_page['url']); ?>"
                           class="btn secondary md:mt-[60px] mx-auto">
                            <?php echo esc_html($book_page['title']); ?>
                            <i class="arrow border-white"></i>
                        </a>
                    <?php endif; ?>

                    <?php if (!empty($block_link)) : ?>
                        <a href="<?php echo esc_url($block_link['url']); ?>"
                           class="btn z-10 mini absolute! md:left-[28.5%] xl:bottom-[9%] md:bottom-[28%] bottom-[75%] sm:left-[32%] left-[15%] lg:bg-transparent! bg-white! lg:text-white! text-black!">
                            <?php echo $block_link['title']; ?>
                            <i class="arrow lg:border-white! border-black! lg-white"></i>
                        </a>
                    <?php endif; ?>

                    <div class="flex items-end justify-between md:mt-[7px] md:mb-[19px] md:static absolute top-1/2 right-5 md:translate-y-0 translate-y-[-80%]">
                        <?php if (!empty($contacts)) : ?>
                            <address itemscope class="not-italic md:block hidden"
                                     itemtype="https://schema.org/Organization">
                                <p class="lg:text-[25px] text-[18px] lowercase text-white lg:mb-[17px] mb-[14px]">
                                    <?php echo esc_html($contacts_title); ?>
                                </p>
                                <?php foreach ($contacts as $contact): ?>
                                    <div class="border-t-[#EEEEF0] border-t pt-[5px] lg:pb-[17px] pb-[14px]">
                                        <p class="flex items-center gap-[3.5px] lg:text-[15px] text-[13px] text-white font-light leading-[normal]">
                                        ...
                                        <?php if (str_contains($contact['link']['url'], 'tel:')): ?>
                                            <div itemprop="contactPoint" itemscope
                                                ...
                                                <a itemprop="telephone"
                                                   class="md:text-[17px]/[normal] text-[15px]/[normal] text-secondary"
                                                   href="<?php echo esc_url($contact['link']['url']); ?>"><?php echo esc_html($contact['link']['title']); ?></a>
                                            </div>
                                        <?php else: ?>
                                            <a class="md:text-[17px]/[normal] text-[15px]/[normal] text-secondary"
                                               href="<?php echo esc_url($contact['link']['url']); ?>"><?php echo esc_html($contact['link']['title']); ?></a>
                                        <?php endif; ?>
                                    </div>
                                <?php endforeach; ?>
                ...
                <div class="container flex xl:flex-row flex-col-reverse h-full">
                                                           ...
                                                           href="<?php echo esc_url($book_page['url']); ?>">
                                                            ...
                                                            <svg aria-hidden="true" class="mobile:w-auto w-[12px]"
                                                                ...
                                                                <path d="M4.41797 11.313L13.522 2.20899L4.41797 11.313ZM22.2126 9.48539C23.2219 10.4947 23.2219 12.1312 22.2126 13.1406L14.2291 21.1241L12.8149 19.7099L20.7984 11.7264C21.0267 11.4981 21.0267 11.1279 20.7984 10.8996L22.2126 9.48539ZM13.522 20.417L4.41797 11.313L13.522 20.417ZM14.2291 1.50188L22.2126 9.48539C23.2219 10.4947 23.2219 12.1312 22.2126 13.1406L20.7984 11.7264C21.0267 11.4981 21.0267 11.1279 20.7984 10.8996L12.8149 2.9161L14.2291 1.50188Z"
                                                                      fill="white"
                                                                      mask="url(#path-1-inside-1_32_2201)"/>
                    ...
                    <div class="h-full uppercase flex flex-col justify-between xl:items-end items-center xl:w-full md:w-max md:gap-10 gap-5 md:py-[60px] py-5">
                        <div class="relative flex justify-between w-full flex-col gap-5 md:pl-10">
                            ...
                            <div class="space-y-5 small-text">
                                <?php echo $text; ?>
                            </div>
                        </div>
                        <?php if (!empty($services_types)) : ?>
        ...
        <?php if ($gallery_block):
            ...
            <section
                ...
                <h2 class="w-full text-white xl:!text-[12vw]/[100%] md:!text-[13vw]/[100%] text-[23vw]/[58%] md:flex items-baseline justify-between">
                    <span class="md:w-auto w-full md:block flex justify-between items-baseline">
                        <?php echo esc_html($gallery_title_first) ?>
                        <span class="md:text-[25px]/[100%] text-[12px] tracking-normal lowercase onest">
                            <?php echo esc_html($gallery_title_accent); ?>
                        </span>
                    </span>
                ...
                <?php if (!empty($gallery_slides)) : ?>
                    <div class="swiper swiper-gallery flex-1 w-full h-full">
                        <div itemscope itemtype="https://schema.org/ImageGallery" class="swiper-wrapper h-full min-h-0">
                            <?php
                                    ...
                                    <div class="slide-image slide-buttons">
                                        <?php if ($is_last) : ?>
                                            <p class="end-slide-text">
                                                ...
                                                <a rel="noopener noreferrer" target="_blank" class="underline"
        ...
        <?php if ($products_block):
            ...
            <section id="products" class="bg-secondary py-10" aria-labelledby="products-title">
                ...
                <?php if (!empty($products)): ?>
                    <div class="max-w-[780px] md:max-w-[1620px] mx-auto px-5! md:px-10! pt-10! mt-10 border-t border-primary">
                        <div class="swiper swiper-products">
                            <div class="swiper-wrapper">
                                <?php foreach ($products as $product): ?>
                                    <div class="swiper-slide h-auto!">
                                        <article class="bg-lite-white p-5 rounded-[30px] flex flex-col gap-5 h-full!"
                                            ...
                                            <div class="text-center max-w-[280px] mx-auto">
                                                <h5 class="text-primary text-[25px]"
                                                    itemprop="name"><?php echo esc_html($product['name']); ?></h5>
                                                <p class="small-text"
                                                   itemprop="description"><?php echo esc_html($product['desc']); ?></p>
                                            </div>
                                        </article>
                                    </div>
                                <?php endforeach; ?>
                            </div>
                            <div class="flex gap-5 items-center mt-10 mx-auto w-max">
                                <button aria-label="Preview product"
                                        class="products-button-prev disabled:opacity-50 -rotate-90 rounded-full borderdark-gray border-1 w-[64px] h-[64px] flex flex-col items-center justify-center cursor-pointer hover:bg-white/60 transition duration-200">
                                    <svg aria-hidden="true" width="16" height="16" viewBox="0 0 16 16" fill="none"
                                         xmlns="http://www.w3.org/2000/svg">
                                        <mask id="path-1-inside-1_32_2239" fill="white">
                                            <path d="M7.21566 12.1219C7.64884 12.5551 8.35116 12.5551 8.78434 12.1219L14.3728 6.53345L8.78434 0.944997C8.35116 0.511815 7.64884 0.511816 7.21566 0.944997L1.6272 6.53345L7.21566 12.1219Z"/>
                                ...
                                <span class="products-swiper-pagination custom-swiper-pagination"></span>
                                <button aria-label="Next product"
                                        class="products-button-next disabled:opacity-50 -rotate-90 rounded-full borderdark-gray border-1 w-[64px] h-[64px] flex flex-col items-center justify-center cursor-pointer hover:bg-white/60 transition duration-200">
                                    <svg aria-hidden="true" width="16" height="16" viewBox="0 0 16 16" fill="none"
                                         xmlns="http://www.w3.org/2000/svg">
                                        <mask id="path-1-inside-1_32_2234" fill="white">
                                            <path d="M7.21566 3.87809C7.64884 3.44491 8.35116 3.44491 8.78434 3.87809L14.3728 9.46655L8.78434 15.055C8.35116 15.4882 7.64884 15.4882 7.21566 15.055L1.6272 9.46655L7.21566 3.87809Z"/>
        ...
        <?php if ($reviews_block):
            ...
            <section id="clients-say" class="bg-secondary md:py-[60px] py-[20px]">
                    ...
                    <div class="swiper swiper-reviews md:px-[33px]! px-5! mt-[27px]">
                        <div class="w-full md:flex items-end flex-col hidden">
                            <div class="flex gap-5 items-center mb-[37px] xl:mr-[267px] mx-auto">
                                ...
                                <span class="reviews-swiper-pagination custom-swiper-pagination"></span>
                ...
                <?php endif; ?>
                <div class="relative flex xl:items-end md:hidden mt-4 mx-auto w-max">
                    <?php if (!empty($block_link)) : ?>
                        <a class="btn mini-gray md:mr-[-25px]" href="<?php echo esc_url($block_link['url']); ?>">
                            <?php echo esc_html($block_link['title']); ?>
                            <i class="arrow"></i>
                        </a>
                    <?php endif; ?>
        ...
        <?php if ($address_block):
            ...
            ?>
            <section id="find-us" class="md:py-[60px] py-5" itemscope itemtype="https://schema.org/LocalBusiness">
                <div class="container">
                    <div class="flex justify-between xl:flex-row flex-col-reverse gap-10">
                        <div class="flex flex-col gap-3.5">
                            <?php if ($map_iframe_link): ?>
                                <p class="sr-only">Map with us location</p>
                                <iframe class="xl:w-[50.83vw] w-full xl:h-[790px] md:h-[395px] h-[193px] md:rounded-[30px] rounded-[15px]"
                        ...
                        <div class="flex xl:flex-col items-end flex-row justify-between w-full">
                            <article
                                    class="relative flex justify-between sm:items-end w-full xl:flex-col sm:flex-row flex-col">
                                <div>
                                    <p class="md:text-[25px] text-[12px] text-secondary"><?php echo esc_html($superheading); ?></p>
                                    <h2 class="xl:text-end max-w-min"><?php echo esc_html($title); ?></h2>
                                </div>
                            ...
                            <div class="relative md:flex items-end hidden">
                                <?php if (!empty($block_link)) : ?>
                                ...
                                <?php if (!empty($google_maps_link)) : ?>
                                    <a aria-label="Open us on google maps" rel="noopener noreferrer" target="_blank"
                    ...
                    <div class="relative flex items-end md:hidden mx-auto w-max">
                        <?php if (!empty($block_link)) : ?>
                            <a class="btn mini" href="<?php echo esc_url($block_link['url']); ?>">
                                <?php echo esc_html($block_link['title']); ?>
                                <i class="arrow"></i>
                            </a>
                        <?php endif; ?>
